...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Trello.png)
...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/usecases.jpg)

<a name="Risk"></a>
## Risk Analysis
Before starting the project, I identified a number of risks which are shown below (click to expand):

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Risks.jpg)
...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Containers.jpg)
...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/ERD.jpg)

The overall structure of the project can be seen here:

https://github.com/amoghvnaik/project2/tree/master/documentation/project_structure.txt
...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Home.png)

### About Page:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/About.png)

### Register Page:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Register.png)

### Login Page:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Login.png)

### Generate Proverb Page:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Generate.png)

### My Proverbs Page:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Myproverbs.png)

### Account Page:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Account.png)
...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Service_1_test.png)

Index.html: https://github.com/amoghvnaik/project2/tree/master/documentation/index1.html

### Service 2:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Service_2_test.png)

Index.html: https://github.com/amoghvnaik/project2/tree/master/documentation/index2.html

### Service 3:

![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/Service_3_test.png)

Index.html: https://github.com/amoghvnaik/project2/tree/master/documentation/index3.html
...
![alt text](https://github.com/amoghvnaik/project2/tree/master/documentation/CI_pipeline.jpg)
