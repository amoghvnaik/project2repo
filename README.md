...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Trello.png)
...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/usecases.jpg)

<a name="Risk"></a>
## Risk Analysis
Before starting the project, I identified a number of risks which are shown below (click to expand):

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Risks.jpg)
...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Containers.jpg)
...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/ERD.jpg)

The overall structure of the project can be seen here:

https://github.com/amoghvnaik/project2/blob/feature1/documentation/project_structure.txt
...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Home.png)

### About Page:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/About.png)

### Register Page:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Register.png)

### Login Page:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Login.png)

### Generate Proverb Page:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Generate.png)

### My Proverbs Page:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Myproverbs.png)

### Account Page:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Account.png)
...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Service_1_test.png)

Index.html: https://github.com/amoghvnaik/project2/blob/feature1/documentation/index1.html

### Service 2:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Service_2_test.png)

Index.html: https://github.com/amoghvnaik/project2/blob/feature1/documentation/index2.html

### Service 3:

![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/Service_3_test.png)

Index.html: https://github.com/amoghvnaik/project2/blob/feature1/documentation/index3.html
...
![alt text](https://github.com/amoghvnaik/project2/blob/feature1/documentation/CI_pipeline.jpg)
